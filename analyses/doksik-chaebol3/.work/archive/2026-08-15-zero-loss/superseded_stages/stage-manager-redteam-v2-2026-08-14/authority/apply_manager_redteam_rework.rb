...
STAGE = File.join(WORK, "stage-manager-redteam-v2-2026-08-14")
TEMP_STAGE = File.join(WORK, ".stage-manager-redteam-v2-2026-08-14.tmp")
...
def completion_text(arcs, pacing, custom, strict, validated:)
  ...
  status = if validated
    "STAGE_READY / AWAITING_MANAGER_V2_STAGE_APPROVAL"
  else
...
write_stage(
  ...
  JSON.pretty_generate({
    "status" => "V2_STAGE_BUILD_INPUTS_VERIFIED",

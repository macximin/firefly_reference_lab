...
if receipt.include?("- 상태: **VALIDATION_PENDING / NOT_STAGE_READY**")
  ...
  must_exclude(receipt, "pending receipt", "AWAITING_MANAGER_V2_STAGE_APPROVAL")
else
  must_include(receipt, "validated receipt", "STAGE_READY", "AWAITING_MANAGER_V2_STAGE_APPROVAL", "금지 조립문 0건", "canonical 적용", "하지 않음")
end
...
puts "PASS semantic-fixed=15,50,154,156,192,194,246,259,264,335,380,382,482,488,495,500,513-516,590,595,598,600,603,605,608,614,625,630,633,636,642-645,648,654,660-662,664,668,672,681,687,688,690,693,710,715,720,731,735,739,744,745,748-751"
